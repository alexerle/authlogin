...
const ALL_SERVICES: ServiceDef[] = [
  {
    ...
    url: 'https://app1.betterassist.me',
    ssoCallbackUrl: 'https://app1.betterassist.me/auth/callback',
    targetDomain: 'app1.betterassist.me',
  ...
  },
  {
    ...
    url: 'https://de01.eazyfind.me',
    ssoCallbackUrl: 'https://de01.eazyfind.me/central-auth-callback',
    targetDomain: 'de01.eazyfind.me',
